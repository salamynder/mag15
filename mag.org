...
Oder man startet die GF-Shell einfach mit ~gf~ (und ohne jedwede Datei-Argumente) und importiert dann mittels ~import~ von der GF-Shell aus die Modul-Dateien:
