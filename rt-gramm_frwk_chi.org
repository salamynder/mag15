...
*** Verwendung unnötig oder gar falsch
Diese Einträge wurden  
#+BEGIN_LaTeX
\DTLloaddbtex{\shide}{tests/shideoveruse.dbtex}
...
\bfseries Vorschlag &
\bfseries Kategorie
\gdef\afterHeaderFlag{\makebox[1em][r]{\scriptsize{\stepcounter{rowcount}\therowcount.}\hspace{0.5em}}}
\\
{\DTLforeach*{\shide}
  {%
  \api=Field1,
...
\begin{longtable}[l]{p{0.28\textwidth} p{0.16\textwidth} p{0.14\textwidth} p{0.04\textwidth} p{0.15\textwidth} p{0.25\textwidth}}
\bfseries API-Funktionen &
\bfseries Englisch &
\bfseries Chinesisch &
\bfseries Ok? &
